...
The basis of step functions are appropriate for continuos random variables. 
...
Bosting provides a linear method for aggregating $M$ weak classifiers. The boosting method takes the arguments ...
...
# log transforamtion of error rate
a_m <- function() {
