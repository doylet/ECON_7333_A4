...
Computation of posterior probabilities for quadratic discriminant analysis in a classifcation problem with one input variable. The QDA approach is suitable for classification problems where observed random variables are drawn from multivairate normal distribution.
...
The QDA model assumes that inputs are normally distributed with the parameters ..  
