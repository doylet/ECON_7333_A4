...
Bosting provides a linear method for aggregating $M$ weak classifiers. The boosting method takes $M$ classifiers of numerical weights, and binary logical response variable. The algorithm is suitable for supervised non-parametrics classification problems, where the models are weakly fitted.
